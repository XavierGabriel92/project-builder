...
outputs: ["research.md"]
approval: {"header": "Research", "preview": "research.md", "options": [{"label": "Approve", "description": "Research is sufficient for planning", "advance": true}, {"label": "Revise", "description": "Do more research before planning", "advance": false, "feedback": true}, {"label": "Exit", "description": "Stop the workflow", "advance": false, "abort": true}]}
---
